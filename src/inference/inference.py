...
from src.prompts.inference import SYSTEM_PROMPT, USER_TEMPLATE, FEW_SHOTS, SYSTEM_PROMPT_BEST_RULES

DATA = "/data/upftfg34/aayguade/dataset/CAT_semantic.json"
BASE_MODEL = "/data/upftfg34/aayguade/models/IberianLLM-7B-Instruct"
MODEL = "/data/upftfg34/aayguade/models/tuned-Iberian/Iberian-LLM-ES"
OUT_FILE = "/data/upftfg34/aayguade/dataset/results_grpo/iDEM-CA-Iberian-LLM-ES2.json"
BATCH_SIZE = 128
