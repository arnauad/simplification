...
dataset_path = "../../../data/filtered/iDEM/iDEM-semantic.json"
predictions_folder = "../../../data/inference/iDEM/rule_search/iDEM-Catallama"
results = "../../../data/eval/sari/rule_search/model_ranking_catallama.json"
